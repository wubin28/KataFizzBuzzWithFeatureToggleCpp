...
${OBJECTDIR}/_ext/275589469/gtest-all.o: ../../gtest-1.7.0/src/gtest-all.cc 
	...
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../gtest-1.7.0 -I../../gtest-1.7.0/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/275589469/gtest-all.o ../../gtest-1.7.0/src/gtest-all.cc

${OBJECTDIR}/_ext/275589469/gtest_main.o: ../../gtest-1.7.0/src/gtest_main.cc 
	${MKDIR} -p ${OBJECTDIR}/_ext/275589469
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -I../../gtest-1.7.0 -I../../gtest-1.7.0/include -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/_ext/275589469/gtest_main.o ../../gtest-1.7.0/src/gtest_main.cc
